...
public class CritterMain {
    public static void main(String[] args) {
        ...
        frame.add(30, Bear.class); // Adds 30 bears to the simulation
        frame.add(30, Tiger.class); // Adds 30 tigers to the simulation
        frame.add(30, WhiteTiger.class); // Adds 30 white tigers to the simulation
        frame.add(30, Giant.class); // Adds 30 giants to the simulation
        frame.add(30, NinjaCat.class); // Adds 30 ninja cats to the simulation
